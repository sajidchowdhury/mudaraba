...
class AdvanceProfitAdjustmentTypeAPlate {
    private $id;
...
$total_fund = 0;
$AdvBalance = new AdvanceTypeADueManager();
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="type" id="type" required  onchange="InvestorRationWiseData(this.value,'TypeA')" class="form-control select2" style="width: 100%;">
        ...
        <table class="table table-striped table-bordered">
            ...
            <tbody id="sectorTableBody">
                ...
                <tr data-sector_id="<?= $ps['id'] ?>">
                    ...
                    <td>
                        <input onchange="updateSectorTotals()" id="sector_adjust_<?= $ps['id'] ?>" class="form-control sector_adjust" 
            ...
            <tfoot>
                ...
                <tr>
                    <th class="text-right">Remaining Fund</th>
