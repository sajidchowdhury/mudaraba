...
class InvestorAdvanceProfitAdjustment extends Dbh {
    ...
    try {
       ...
       date_default_timezone_set('Asia/Dhaka');
        ...
        $stmt = $db->prepare("INSERT INTO `investor_advance_profit_adjustment` 
            (`investor_id`, `amount`, `month`,`transaction_date` )
            VALUES 
            (:investor_id, :amount, :transaction_month,:transaction_date)");
