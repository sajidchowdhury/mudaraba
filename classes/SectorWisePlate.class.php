                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="sector_id" id="sector_id" onchange="SectorDue(this.value)" required class="form-control select2" style="width: 100%;">
                                            <option value="">Select One</option>
        HTML;

        foreach ($List->ListData() as $row) {
            $selected = ($sector_id == $row['id']) ? 'selected' : '';
