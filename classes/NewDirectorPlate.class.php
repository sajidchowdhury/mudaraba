...
class NewDirectorPlate {
    ...
    public function SetupForm() { 
        ...
        // Default blank values
         $director_name = '';$mobile = time() ;

        // Fetch existing data if editing
        if ($this->id !== 'New') {
            $fetch = new NewDirector();
            $data = $fetch->SingleData($this->id);

            if ($data) { 
                $director_name   = htmlspecialchars($data['name']);
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input  type="text" required class="form-control" name="director_name" id="director_name" value="<?=
                                                  $director_name ?>">
                                            </div>
                                        </div>
