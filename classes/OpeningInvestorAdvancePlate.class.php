...
class OpeningInvestorAdvancePlate {
    private $id;
        ...
        <div class="row">
            <div class="col-md-12">
                <form id="myForm" method="post">
                    ...
                    <input type="hidden" name="action_type" value="investor">
                    <input type="hidden" id="pageName" value="Opening-Investor-Advance">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="action_id">Investor Name</label>
